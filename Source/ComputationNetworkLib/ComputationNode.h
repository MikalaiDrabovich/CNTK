...
public:
    ...
    bool IsOutputNeededDuringBackprop() const { return !Globals::ShouldEnableShareNodeValueMatrices() || m_outputNeededDuringBackprop; }
...
public:
    ...
    virtual void /*IComputationNode::*/ EndBackprop() override
    {
        ...
        if (IsValueSharable() && Globals::ShouldEnableShareNodeValueMatrices())
        {
            if (GradientPtr()) 
                Gradient().Resize(0, 0);
